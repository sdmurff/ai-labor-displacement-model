...
const rawData: Array<{ soc: string; name: string; employment: number; observed: number; alpha: number; beta: number; gamma: number }> = [
  { soc: "11", name: "Management", employment: 8909920, observed: 0.1304, alpha: 0.0983, beta: 0.4509, gamma: 0.8034 },
  { soc: "13", name: "Business & Finance", employment: 9053780, observed: 0.2844, alpha: 0.1729, beta: 0.5282, gamma: 0.8836 },
  { soc: "15", name: "Computer & Math", employment: 4654750, observed: 0.3577, alpha: 0.3677, beta: 0.6342, gamma: 0.9008 },
  { soc: "17", name: "Architecture & Engineering", employment: 2436520, observed: 0.0451, alpha: 0.1900, beta: 0.4887, gamma: 0.7873 },
  { soc: "19", name: "Life & Social Sciences", employment: 1273610, observed: 0.1045, alpha: 0.2007, beta: 0.4646, gamma: 0.7285 },
  { soc: "21", name: "Social Services", employment: 2239700, observed: 0.0401, alpha: 0.1678, beta: 0.3420, gamma: 0.5163 },
  { soc: "23", name: "Legal", employment: 1178140, observed: 0.2037, alpha: 0.0963, beta: 0.4634, gamma: 0.8304 },
  { soc: "25", name: "Education & Library", employment: 8191940, observed: 0.1819, alpha: 0.1413, beta: 0.3594, gamma: 0.5776 },
  { soc: "27", name: "Arts & Media", employment: 1815270, observed: 0.1916, alpha: 0.1989, beta: 0.4556, gamma: 0.7123 },
  { soc: "29", name: "Healthcare Practitioners", employment: 8787720, observed: 0.0547, alpha: 0.1111, beta: 0.3451, gamma: 0.5792 },
  { soc: "31", name: "Healthcare Support", employment: 6603660, observed: 0.0226, alpha: 0.0783, beta: 0.1666, gamma: 0.2549 },
  { soc: "33", name: "Protective Service", employment: 3385060, observed: 0.0288, alpha: 0.1520, beta: 0.2588, gamma: 0.3655 },
  { soc: "35", name: "Food & Serving", employment: 11201470, observed: 0.0087, alpha: 0.0903, beta: 0.1497, gamma: 0.2092 },
  { soc: "37", name: "Grounds Maintenance", employment: 4108810, observed: 0.0057, alpha: 0.0160, beta: 0.0419, gamma: 0.0678 },
  { soc: "39", name: "Personal Care", employment: 2566450, observed: 0.0210, alpha: 0.1377, beta: 0.2110, gamma: 0.2844 },
  { soc: "41", name: "Sales", employment: 13256290, observed: 0.2690, alpha: 0.2166, beta: 0.4251, gamma: 0.6337 },
  { soc: "43", name: "Office & Admin", employment: 18299370, observed: 0.3434, alpha: 0.3148, beta: 0.5620, gamma: 0.8092 },
  { soc: "45", name: "Agriculture", employment: 451850, observed: 0.0127, alpha: 0.0390, beta: 0.1089, gamma: 0.1789 },
  { soc: "47", name: "Construction", employment: 5848940, observed: 0.0111, alpha: 0.0251, beta: 0.1044, gamma: 0.1837 },
  { soc: "49", name: "Installation & Repair", employment: 5574400, observed: 0.0156, alpha: 0.0562, beta: 0.1363, gamma: 0.2165 },
  { soc: "51", name: "Production", employment: 8408020, observed: 0.0068, alpha: 0.0553, beta: 0.1305, gamma: 0.2057 },
  { soc: "53", name: "Transportation", employment: 12639900, observed: 0.0021, alpha: 0.0759, beta: 0.1532, gamma: 0.2305 },
];

export const socGroups: SOCGroup[] = rawData.map((d) => ({
  ...d,
  defaults: {
    currentAutomation: d.observed,
